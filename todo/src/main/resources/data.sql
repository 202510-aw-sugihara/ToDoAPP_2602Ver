...
insert into users (username, password, roles, enabled) values ('user', '{noop}password', 'ROLE_USER', true);
insert into users (username, password, roles, enabled) values ('admin', '{noop}adminpass', 'ROLE_ADMIN', true);
